...
namespace Couchbase.AspNet.UnitTests
{
    public class CouchbaseCacheProviderTests
    {
        ...
        [InlineData("", false)]
        [InlineData(" ", false)]
        public void Get_When_Key_IsNullEmptyOrSpace_DoNot_Throw_ArgumentException_If_ThrowOnError(string key, bool throwOnError)
        {
            var bucket = new Mock<IBucket>();
            bucket.Setup(x => x.Get<dynamic>(It.IsAny<string>())).Throws<MissingKeyException>();

            var provider = new CouchbaseCacheProvider(bucket.Object)
            {
        ...
        public void Get_When_Key_DoesNotExist_Return_Null(bool throwOnError)
        {
            ...
            var provider = new CouchbaseCacheProvider(bucket.Object) {ThrowOnError = throwOnError};
        ...
        public void Get_When_Operation_Causes_Exception_Throw_Exception()
        {
            ...
            var provider = new CouchbaseCacheProvider(bucket.Object) { ThrowOnError = true };
        ...
        {
            var provider = new CouchbaseCacheProvider(null) { ThrowOnError = throwOneError };
        ...
        public void Set_When_Operation_Causes_Exception_Throw_CouchbaseCacheException()
        {
            ...
            var bucket = new Mock<IBucket>();
            bucket.Setup(x => x.Upsert(It.IsAny<string>(), It.IsAny<object>(), It.IsAny<TimeSpan>())).Returns(result.Object);
        ...
        public void Add_When_Operation_Fails_Throw_CouchbaseCacheException(bool throwOnError)
        {
            ...
            bucket.Setup(x => x.Insert<dynamic>(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TimeSpan>())).Returns(result.Object);
        ...
        public void Add_When_Key_DoesNotExst_Inserts_Value(bool throwOnError)
        {
            ...
            bucket.Setup(x => x.Insert<dynamic>(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TimeSpan>())).Returns(insert.Object).Verifiable();
